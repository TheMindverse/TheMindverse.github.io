...
Once you've connected to the mindverse and have entered the flow, navigating the multiverse is the next step to master.
If you wish to accurately control which dimension you want to travel to, instead of blindly being thrown into them based on your emotions, you must first understand how the multiverse works and how to view it.
Each dimension in the multiverse is a layer, and there are stacks and stacks of layers all on top of each other.

You can flip through them as you travel the outer pathways that connect them all.
Learn how it is organized, learn why each are different from the last, and learn why they are placed in the order that they are.
...
Due to the nature of infinitely, there are infinite possibilities of every action, time, and place, as dimensions.
...
Deadwalking is a technique used to navigate the mindverse while still living our your daily life simultaneously, a form of interdimensional multi-tasking.
Deadwalking is considered a  dangerous act as it is guaranteed to cause the side effects listed in [safety practices](pages/guides/safetypractices.md).
Deadwalking requires a mastery of being able to control your state of mind simply by thinking it, no longer needing to meditate or do practice rituals to connect to the mindverse.
